...
namespace E_OKUL
{
    public partial class FrmKulup : Form
    {
        ...
        {
            liste();
            MessageBox.Show("Listeleme İşlemi Başarıyla Gerçekleşti!");
        }
        ...
        {
            PicClose.BackColor = Color.LightBlue;
        }
        ...
        private void BtnSil_Click(object sender, EventArgs e)
        {
            ...
            komut.ExecuteNonQuery();
            baglanti.Close();
            MessageBox.Show("Kulüp Silme İşlemi Başarıyla Gerçekleşti!");
            liste();
        ...
        private void BtnGuncelle_Click(object sender, EventArgs e)
        {
            ...
            komut.ExecuteNonQuery();
            baglanti.Close();
            MessageBox.Show("Kulüp Güncelleme İşlemi Başarıyla Gerçekleşti!");
            liste();
